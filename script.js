window.addEventListener("DOMContentLoaded", (event) => {
  ...
  if (slider) {
    ...
    setInterval(nextSlideHeader, 8000);
    ...
    function showslideOficinas(n) {
      ...
      currentslideOficinas =
        (n + slidesOficinas.length) % slidesOficinas.length;
    ...
    const sliderindicatorCircular = document.querySelector(
      ".sliderindicatorCircular"
    );
    const sliderindicatorCircularWrapper = document.querySelector(
      ".sliderindicatorCircular-wrapper"
    );
    ...
    var contenedorImagenScroll = document.getElementById(
    ...
    contenedorPrincipalScroll.addEventListener("wheel", function (event) {
      ...
      if (scrollVerticalEnabled) {
        ...
        if (
          contenedorImagenScroll.scrollLeft ===
          contenedorImagenScroll.scrollWidth -
            contenedorPrincipalScroll.clientWidth
        ) {
    ...
    contenedorImagenScroll.addEventListener("scroll", function () {
      ...
      if (progress >= 100) {
        ...
        barraAvance.style.background =
          "linear-gradient(to right, #FA6400, #FFAB76)";
      }
    });
    ...
    const circleScrollHotizontals = document.querySelectorAll(
      ".circleScrollHotizontal"
    );
    ...
    document.addEventListener("scroll", () => {
      ...
      sections.forEach((section, index) => {
        ...
        if (
          scrollPositionVertical >= sectionTop &&
          scrollPositionVertical < sectionTop + sectionHeight
        ) {
      ...
      const activeCircleIndex = Array.from(circleScrollHotizontals).findIndex(
    ...
    function showSlideHeaderMobile(n) {
      ...
      currentSlideHeaderMobile =
        (n + slidesHeaderMobile.length) % slidesHeaderMobile.length;
    ...
    const sliderindicatorCircularMobile = document.querySelector(
      ".sliderindicatorCircularMobile"
    );
    const sliderindicatorCircularWrapperMobile = document.querySelector(
      ".sliderindicatorCircularMobile-wrapper"
    );
    const indicatorCircularsMobile = document.querySelectorAll(
      ".indicatorCircularMobile"
    );
    ...
    // JavaScript
    var contenedorImagenScrollMobile = document.getElementById(
      "scrollHorizontal-imagenMobile"
    );
    ...
    contenedorImagenScrollMobile.addEventListener(
      "touchstart",
      function (event) {
    ...
    function updateProgressBar() {
      ...
      var totalScrollWidth =
        contenedorImagenScrollMobile.scrollWidth -
        contenedorImagenScrollMobile.clientWidth;
      var currentScrollLeft = contenedorImagenScrollMobile.scrollLeft;
      var scrollPercentage = (currentScrollLeft / totalScrollWidth) * 80;
      document.getElementById("barra-avanceScrollMobile").style.width =
        scrollPercentage + "%";
    }
    // fin scroll horizontal
    ...
    const slidesOficinasMobile = document.querySelectorAll(
      ".slideOficinasMobile"
    );
    const indicatorsOficinasMobile = document.querySelectorAll(
      ".indicatorOficinasMobile"
    );
    let currentslideOficinasMobile = 0;

    function showslideOficinasMobile(n) {
      slidesOficinasMobile[currentslideOficinasMobile].classList.remove(
        "active"
      );
      indicatorsOficinasMobile[currentslideOficinasMobile].classList.remove(
        "active"
      );
      currentslideOficinasMobile =
        (n + slidesOficinasMobile.length) % slidesOficinasMobile.length;
      slidesOficinasMobile[currentslideOficinasMobile].classList.add("active");
      indicatorsOficinasMobile[currentslideOficinasMobile].classList.add(
        "active"
      );
    }
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      imageChica.addEventListener("click", () => {
        ...
        for (let j = 1; j <= 5; j++) {
          ...
          const otherImageChicaGrande = document.querySelector(
            `.imagen${j}Grande`
          );
